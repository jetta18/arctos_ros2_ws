...
def generate_launch_description():
    ...
    robot_description_content = Command(
        [
            ...
            " ",
            PathJoinSubstitution([arctos_description_dir, "urdf", "arctos_v2.urdf.xacro"]),
        ]
    )
    ...
    ros2_controllers_params = os.path.join(
        arctos_description_dir, 'config', 'ros2_controllers_v2.yaml'
    )
    ...
    return LaunchDescription([
        LogInfo(msg=["Launching Arctos Robot System (v2 trajectory mode)..."]),
